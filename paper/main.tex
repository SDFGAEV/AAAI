...
The correct question is counterfactual: \textbf{``does reusing this knowledge \emph{cause} better outcomes than not reusing it, in this specific context?''} Answering it requires comparing outcomes \emph{with} and \emph{without} the knowledge. A candidate may succeed in its source episodes due to initial inventory, planner capability, or environmental shortcuts---none of which transfer. Conversely, statistically successful knowledge may interfere with previously mastered same-category skills---a phenomenon we term \emph{passive interference}.
